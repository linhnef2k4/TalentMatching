...
const ConversationItem = React.memo(({ conv, isActive, onSelect }) => (
    <div
        ...
        className={`
            ...
            ${isActive ? 'bg-blue-50 border-l-4 border-l-blue-600' : 'hover:bg-white border-l-4 border-l-transparent'}
        `}
    >
                    ...
                    <div className="p-4 border-b border-gray-200 shrink-0">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full bg-white border border-gray-300 rounded-xl pl-9 pr-4 py-2 text-sm outline-none focus:border-blue-500 transition"
                            />
                            {searchQuery && (
                                <button
                            ...
                            <>
                                ...
                                {activeContact?.isNew && (
                                    <div
                                        ...
                                        className="flex items-center gap-3 p-4 cursor-pointer border-b border-gray-100 bg-blue-50 border-l-4 border-l-blue-600"
                                    >
                                        <Avatar
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <p className="text-[13px] truncate text-blue-600 font-medium">
                                                Liên hệ mới
                                            </p>
                                        </div>
                                    </div>
                                                ...
                                                >
                                                    <div
                                                        className={[
                                                            ...
                                                            !isMedia && isMe
                                                                ? `bg-blue-600 text-white rounded-br-none ${item.optimistic ? 'opacity-70' : ''}`
                                                                : '',
                                                            !isMedia && !isMe
                                                    ...
                                                    >
                                                        {fmt(item.createdAt)}
                                                        {item.optimistic && (
                                                            <span className="ml-1 text-blue-300">· Đang gửi…</span>
                                                        )}
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div className="flex-shrink-0 px-4 py-3 border-t border-gray-200 bg-white relative">
                                ...
                                <form
                                    ...
                                    className={`flex items-end gap-2 bg-gray-50 border rounded-3xl pl-2 pr-2 py-2 transition-all ${
                                        wsStatus === 'connected'
                                            ? 'border-gray-300 focus-within:border-blue-400 focus-within:ring-4 focus-within:ring-blue-50 focus-within:bg-white'
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-1 pb-1">
                                        ...
                                        <button
                                            ...
                                            className="text-gray-400 hover:text-blue-600 w-10 h-10 flex items-center justify-center rounded-full hover:bg-gray-200 transition-all shrink-0 disabled:opacity-40"
                                            title="Đính kèm tệp"
                                        >
                                            <ImageIcon size={20} />
                                        </button>
                                    ...
                                    <button
                                        ...
                                        className="w-10 h-10 shrink-0 mb-0.5 bg-blue-600 rounded-full flex items-center justify-center text-white hover:bg-blue-700 active:scale-95 transition-all disabled:bg-slate-200 disabled:cursor-not-allowed"
                                        title="Gửi"
                                    >
                                        {isUploading ? (
